...
ctSingleAssay<-read.csv("data/TTR & InvA master file Ct for correlation.csv",na.strings=c("Undetermined"))
ctTAC<-read.csv("data/TAC Results_4Marc TAC TTR TAC InvA Ct For Correlation.csv",na.strings=c("0","Undetermined"))
...
png("output/lmmFits_CorrelationBetweenTestsRepeatedMeasurements_Ct.png",width=10,height=10,units="in",res=600)
...
png("output/lmmFits_PositiveDiagnosticConcordance.png",width=10,height=10,units="in",res=600)
...
png("output/lmmFits_NegativeDiagnosticConcordance.png",width=10,height=10,units="in",res=600)
...
png("output/lmmFits_CorrelationAndConcordance.png",width=30,height=10,units="in",res=600)
par(mfrow=c(1,3))
